...
import type { MeetingBotCategory } from '#/components/meetings-data-table'
...
export const Route = createFileRoute('/_app/bot-board')({
  pendingComponent: BotBoardPending,
  loader: async () => {
    ...
    try {
      ...
      console.error('[bot-board] calendar sync failed:', message)
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : String(error)
      console.error('[bot-board] getStoredMeetings failed:', message)
...
function BotBoardPending() {
  return (
    <main
      className="mx-auto max-w-7xl px-4 py-12 sm:px-6"
      aria-busy="true"
      aria-label="Loading bot board"
    >
