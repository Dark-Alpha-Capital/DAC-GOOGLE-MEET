/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c1d3a5ce330331237b235d76b5742445)
// Runtime types generated with workerd@1.20260708.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
    DB: D1Database;
    AI: Ai;
    BETTER_AUTH_URL: "https://dac-google-meet.rahulguptax14.workers.dev";
    BOT_DISPLAY_NAME: "DAC Notetaker";
    ...
    MEET_BOT_CONTAINER: DurableObjectNamespace<import("./src/server").MeetBotContainer>;
    MEETING_BOT_WORKFLOW: Workflow<Parameters<import("./src/server").MeetingBotWorkflow['run']>[0]['payload']>;
    MEETING_NOTES_WORKFLOW: Workflow<Parameters<import("./src/server").MeetingNotesWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./src/server");
        durableNamespaces: "MeetBotContainer";
    }
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BOT_DISPLAY_NAME" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BOT_INTERNAL_SECRET" | "OPENAI_API_KEY" | "NEXTCLOUD_URL" | "NEXTCLOUD_USER" | "NEXTCLOUD_PASSWORD">> { }
}
